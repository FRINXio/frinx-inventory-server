// INFO: code shamelessly stolen from https://github.com/graphql/graphql-relay-js/blob/3796e0904fbfe0dd86e540d5b4df236330c8a5e7/src/utils/base64.ts
// used for custom connectionFromArray function
